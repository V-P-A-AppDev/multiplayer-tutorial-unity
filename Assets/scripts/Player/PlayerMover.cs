...
public class PlayerMover : MonoBehaviourPun
{
    ...
    void Update()
    {
        ...
        animatorManager.UpdateAnimatorValues(0, moveAmount, Input.GetKeyDown(KeyCode.LeftShift));
        ...
        PlayerSee.transform.Rotate(-rotY * rotaionSpeed, 0, 0.0f);
    }
}
